...
class CustomerAPI(object):
    ...
    def create_saved_payment(self, credit_card, address=None, profile_id=None):
        ...
        credit_card_type.expirationDate = "{0.exp_year}-{0.exp_month:0>2}".format(
            credit_card
        )
        ...
        if profile_id:
            response = self._make_call(
                "CreateCustomerPaymentProfile", profile_id, payment_profile, "none"
            )
    ...
    def auth(self, profile_id, payment_id, amount):
        ...
        response = self._make_call(
            "CreateCustomerProfileTransaction", transaction, self.transaction_options
        )
